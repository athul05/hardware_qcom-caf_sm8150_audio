...
ifneq ($(filter msm8974 msm8226 msm8084 msm8610 apq8084 msm8994 msm8992 msm8996 msm8998 apq8098_latv sdm845 sdm710 qcs605 sdmshrike msmnile kona sdm660 msm8937 $(MSMSTEPPE) $(TRINKET) lito atoll,$(PRODUCT_BOARD_PLATFORM)),)
  # B-family platform uses msm8974 code base
  AUDIO_PLATFORM = msm8974
  MULTIPLE_HW_VARIANTS_ENABLED := true
ifneq ($(filter msm8974,$(PRODUCT_BOARD_PLATFORM)),)
...
ifneq ($(filter msm8084,$(PRODUCT_BOARD_PLATFORM)),)
...
ifneq ($(filter msmnile sdmshrike,$(PRODUCT_BOARD_PLATFORM)),)
...
ifneq ($(filter lito,$(PRODUCT_BOARD_PLATFORM)),)
  LOCAL_CFLAGS := -DPLATFORM_LITO
  LOCAL_CFLAGS += -DMAX_TARGET_SPECIFIC_CHANNEL_CNT="4"
  LOCAL_CFLAGS += -DINCALL_STEREO_CAPTURE_ENABLED
endif
ifneq ($(filter atoll,$(PRODUCT_BOARD_PLATFORM)),)
...
ifneq ($(filter msm8937,$(PRODUCT_BOARD_PLATFORM)),)
